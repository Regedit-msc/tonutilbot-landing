...
const RoadmapCard: FC<IProps> = ({
  ...
  return (
    <div
      className={`${className} flex w-full text-white pt-20 sm:pt-[6rem] pb-8 sm:pb-12 min-[920px]:pb-10 rounded-[1.4rem] border border-[#ffffff07] flex-grow text-start relative bg-gradient-to-b from-white/[8%] to-white/[3%] min-[920px]:h-[340px] overflow-hidden`}
    >
