...
export const BuySwapOrSell = () => {
  ...
  return (
    <div className="text-white">
      <div className="flex flex-col justify-center items-center text-center gap-10 mb-20 sm:mb-40 sm:mt-20 mt-10 lg:mt-40 relative">
        <Transition>
        ...
        <div className="flex justify-center items-center max-lg:flex-wrap gap-10 lg:gap-14 lg:mt-6">
          {cards.map((card, i) => (
            <Transition key={i}>
              <Card
