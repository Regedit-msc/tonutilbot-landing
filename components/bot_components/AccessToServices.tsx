    ...
    <div className="bg-purple flex-col sm:flex-row flex justify-center text-white sm:gap-8 px-8 pt-20 -translate-y-2 overflow-x-hidden min-h-screen">
      ...
      <section className="flex flex-col gap-3 sm:max-w-[50vw] py-10 md:pl-[5vw] lg:pl-[8vw]">
        ...
        <div className="flex flex-col xs:flex-row gap-2 xs:items-center">
          ...
          <span className="bg-white px-3 py-[6px] lg:py-2 lg:px-5 lg:text-lg rounded-full flex gap-2 border-[4px] lg:border-[6px] border-purple/70 text-blue font-medium text-nowrap items-center text-sm sm:text-base w-fit">
        ...
        <p className="text-balance sm:text-lg md:text-xl font-light lg:text-2xl">
